...
use Webconsulting\Skillflow\Domain\Security\SkillspectorReport;
use Webconsulting\Skillflow\Support\Typed;

/**
 * Runs NVIDIA SkillSpector (github.com/NVIDIA/skillspector) against one skill
 * as part of the mandatory import review checks. The skill is materialized
...
final class SkillspectorScanner
{
    ...
    {
        $identifier = $skill->identifier !== '' ? $skill->identifier : 'skill';
        $runDirectory = Environment::getVarPath() . '/transient/skillflow/spector-' . bin2hex(random_bytes(8));
